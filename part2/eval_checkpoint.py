#!/usr/bin/env python3
"""Load a T5 from-scratch checkpoint from an MLflow run (or output dir) and evaluate on dev examples.

Usage examples:
    # Auto-find the best MLflow run for part2
    ...
    python part2/eval_checkpoint.py --mlflow_run_id abc123
...
def find_best_mlflow_run(experiment_name="part2_t5_scratch"):
